...
class CompanyThemeUpdate(BaseModel):
    ...
    @field_validator("primary_color", "secondary_color", "accent_color", "background_color", "surface_color", "text_color", "color_1", "color_2", "color_3", "color_4", "color_5", mode="before")
    @classmethod
    def check_hex(cls, v):
