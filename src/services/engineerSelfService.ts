...
const mapApiEngineerToFrontend = (apiEng: any): Engineer => {
  return {
    ...
    yearsExperience: apiEng.industry_experience !== undefined && apiEng.industry_experience !== null ? String(apiEng.industry_experience) : '',
    customerExperience: apiEng.customer_experience !== undefined && apiEng.customer_experience !== null ? String(apiEng.customer_experience) : (apiEng.lam_experience !== undefined && apiEng.lam_experience !== null ? String(apiEng.lam_experience) : ''),
